...
RSpec.describe AddressBook do
  ...
  describe "#import_from_csv" do
    ...
    describe "#binary_search" do
      ...
      it "searched AddressBook for Bob" do
        book.import_from_csv("entries.csv")
      ...
      it "searched AddressBook for Joe" do
        book.import_from_csv("entries.csv")
      ...
      it "searched AddressBook for Sally" do
        book.import_from_csv("entries.csv")
      ...
      it "searched AddressBook for Sussie" do
        book.import_from_csv("entries.csv")
      ...
      it "seached AddressBook for Billy" do
        book.import_from_csv("entries.csv")
